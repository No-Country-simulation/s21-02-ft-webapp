...
export const AccountMovementsContainer = () => {
    ...
    return (
        <div className="w-full px-4 sm:px-6 lg:px-8 items.start">
            <div className="max-w-7xl mx-auto items.start">
                <div className="mb-6 flex flex-col items- w-full">
                    <label
                        htmlFor="accountSelect"
                        className="block text-sm font-bold text-slate-700 mb-2 mt-4"
                    >
                        Seleccione cuenta:
                    </label>
                    <select
