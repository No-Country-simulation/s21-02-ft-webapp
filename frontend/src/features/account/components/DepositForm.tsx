...
export const DepositForm = ({ sourceAccountId, sourceAccountName }: DepositFormProps) => {
  const {
      ...
      <div className="flex flex-col items-center min-h-screen mt-10">
        <Card className="w-full max-w-md p-6">
          <div className="text-center space-y-4">
            ...
            <h2 className="text-2xl font-bold text-gray-800">Deposito exitoso</h2>
      ...
      <Card className="w-full max-w-md">
        <div className="p-6">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800">Depositar {currency}</h2>
