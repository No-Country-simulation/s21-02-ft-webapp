...
public class CardService implements ICardService {
    ...
    public CardResponseDTO createCard(RegisterCardRequestDTO cardRequestDTO) {
        ...
        Card card = this.createCardObject(user, cardRequestDTO);
    ...
    public List<CardResponseDTO> getCardsByUserDni(DniRequestDTO dniRequestDTO) {
        User user = this.userContextService.validateUserAccess(dniRequestDTO.dni());
    ...
    private Card createCardObject(User user, RegisterCardRequestDTO cardRequestDTO) {
        Card card = new Card();
